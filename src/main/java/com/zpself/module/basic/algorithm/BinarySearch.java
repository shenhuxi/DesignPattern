...
public class BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        int findValue = 6;
        /*System.out.println(searchRecursive(array, 0, array.length - 1, findValue));
        System.out.println(count);*/
        System.out.println(searchLoop(array, findValue));
        System.out.println(count);
    }
    /**
     * 循环二分查找，返回第一次出现该值的位置
     ...
     */
    private static int searchLoop(int[] array, int findValue) { // 如果数组为空，直接返回-1，即查找失败
