package com.zpself.module.springSecurity.utils;
...
//        byte[] encodedKey = Base64.decode(null);
...
//    }
     ...
     * @return
     */
    public static String generateToken(SelfUserDetails user){
        return Jwts.builder()
